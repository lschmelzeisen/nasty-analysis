...
format-licenseheaders: ##- Prepend license headers to all code files.
	@licenseheaders --tmpl LICENSE.header --years 2020 --owner "Lukas Schmelzeisen" --dir src
	@licenseheaders --tmpl LICENSE.header --years 2020 --owner "Lukas Schmelzeisen" --dir stubs --additional-extensions python=.pyi
	@licenseheaders --tmpl LICENSE.header --years 2020 --owner "Lukas Schmelzeisen" --dir tests
